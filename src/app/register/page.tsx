              ...
              <motion.div variants={staggerContainer} initial="hidden" animate="show" className="relative z-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <motion.div variants={springItem} className="pt-2">
                    ...
                    <Button 
                      type="button"
                      className="neo-button w-full h-12 rounded-xl font-bold text-sm bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_10px_30px_-10px_rgba(220,38,38,0.5)] flex items-center justify-center gap-2 mt-3 transition-all duration-300"
                    >
                      <svg className="h-4 w-4 text-primary-foreground" viewBox="0 0 24 24">
                        <path
                          fill="currentColor"
